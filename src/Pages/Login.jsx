        ...
        <div className="card w-full py-3 shadow-xl bg-base-100">
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className="form-control mt-6">
              <button className="py-2 rounded-md bg-green-500 hover:bg-green-400 hover:text-black text-white font-semibold">
                Sign In
              </button>
            </div>
          </form>
          ...
          <div className=" my-2 px-8 w-full ">
            ...
            <button
              ...
              className="py-2 rounded-md w-full border bg-green-200 border-green-500 hover:bg-green-400 hover:text-black font-semibold"
            >
